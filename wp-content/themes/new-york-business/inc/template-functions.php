	...
	echo '<div class="row multi-columns-row">';
		while ( $loop->have_posts() ) :
			...
			<div class="product-wrapper">
				...
				<div class="product-image-wrapper" style="height:<?php echo $image_height; ?>px" >
...
function new_york_business_product_slider($args, $image_height, $css_class, $slider_speed, $nav_color = '#2d2c2cc2' ){
		...
		//carousal begin
		echo '<div id="'.$carousal_id.'" class="carousel slide" data-ride="carousel" data-interval="'.$slider_speed.'" >';
		...
		foreach ($items as $slides) {
		   ...
		   $active = '';
				...
				?>
					<div class="<?php if($colums != 5){ echo $css_class; } else { echo $css_class.$offfset_css; $offfset_css=''; } ?>" >
						<div class="product-wrapper">
							...
							<div class="product-description">
								...
								<span class="price">
									...
									if ( $slideritem->price_html ) {
										echo wp_kses($slideritem->price_html, $allowed_html);
									}
									?>					
								</span>
								<div class="product-rating-wrapper">
									<?php 
									global $allowed_html;
									echo wp_kses($slideritem->rating_html, $allowed_html); 
									?>
								</div>
							</div> <!--end product description-->
		...
		if($item_count>1){	
			echo '<ul class="carousel-navigation ">
				   	<li><a class="carousel-prev" href="#'.$carousal_id.'" data-slide="prev" style=background-color:'.$nav_color.';></a></li>
				   	<li><a class="carousel-next" href="#'.$carousal_id.'" data-slide="next" style=background-color:'.$nav_color.';></a></li>
				  </ul>';
		}
